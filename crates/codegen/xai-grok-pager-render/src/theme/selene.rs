//! Selene theme — deep indigo-charcoal base, silver-moonlight accent.
//!
...
// Selene palette — night-sky blues with a silver lunar accent.
#[allow(dead_code)]
mod palette {
    use super::*;
...
mod tests {
    ...
    #[test]
    fn selene_is_dark_with_distinct_accents() {
        let t = Theme::selene();
        assert!(t.is_dark());
