...
impl Default for GrokComConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            oidc,
            oauth2,
            auth_provider_command: xai_grok_env::var("AMORE_AUTH_PROVIDER_COMMAND").ok(),
            auth_provider_label: xai_grok_env::var("AMORE_AUTH_PROVIDER_LABEL").ok(),
            auth_token_ttl: xai_grok_env::var("AMORE_AUTH_TOKEN_TTL")
                .ok()
