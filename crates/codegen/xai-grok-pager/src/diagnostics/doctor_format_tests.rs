...
fn healthy_local_output_is_stable() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "Instruments\n",
            "  iris             not installed\n",
            "  iris home        home unavailable\n",
            "  lucerna          not installed (opt-in)\n",
            "  speculum         not installed (opt-in)\n",
...
fn tmux_config_and_reload_notes_output_is_stable() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "      Automatic setup: `amore doctor fix dcs-passthrough`\n",
            ...
            "      Automatic setup: `amore doctor fix tmux-extended-keys`\n",
