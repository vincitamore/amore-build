...
impl TitleManager {
    ...
    pub fn update(&mut self, state: &TitleState<'_>) -> Option<String> {
        ...
        if !has_parts {
            self.composed.clear();
            self.composed.push_str(&crate::app::cli::resolved_bin_name());
        }
    ...
    pub fn reset(&mut self) -> String {
        let name = crate::app::cli::resolved_bin_name();
...
fn write_item(
    ...
    match item {
        TitleItem::Grok => {
            ...
            buf.push_str(&crate::app::cli::resolved_bin_name());
        }
        TitleItem::Spinner => {
...
mod tests {
    ...
    #[test]
    fn product_name_only_renders_product() {
