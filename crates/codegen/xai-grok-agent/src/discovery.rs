...
/// Project-level agent directories to scan (`.amore/agents/` fork-native, `.grok/agents/` legacy, plus `.claude/agents/` for compat).
const PROJECT_AGENT_SUBDIRS: &[&str] = &[".amore/agents", ".grok/agents", ".claude/agents"];
