...
use super::{
    ...
    post_tool_use_json_to_outcome, prompt_json_to_block, stop_json_to_outcome, parse_observe_additional_context};
...
pub async fn run_http_hook(
    ...
    let result = match mode {
        ...
        // Observe hooks may return SessionStart-style additionalContext in the body.
        GateKind::Observe if status.is_success() => HookRunnerResult::success_with_context(
            parse_observe_additional_context(&response_text),
        ),
