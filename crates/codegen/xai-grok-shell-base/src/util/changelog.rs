...
//! into the binary from `assets/selene-changelog.{md,json}`.
//!
...
const CHANGELOG_MD: &str = include_str!("../../assets/selene-changelog.md");
const CHANGELOG_JSON: &str = include_str!("../../assets/selene-changelog.json");
    ...
    fn baked_changelog_parses_and_fills_welcome_bullets() {
        ...
        assert!(
            changelog
                .markdown
                .as_deref()
                .is_some_and(|m| m.contains("Selene")),
