...
.selene/hooks/ path prefix). Exit 0 only if every case passes.
"""
...
def main() -> int:
    with tempfile.TemporaryDirectory() as td:
        ...
        env["SELENE_HOME"] = str(home)
        env.pop("SELENE_SESSION_INIT_NOW", None)
        ...
        # --- Session-init ---
        env_due = dict(env)
        env_due["SELENE_SESSION_INIT_NOW"] = "2026-07-30T12:00:00"
