...
bun .selene/skills/sortes/bin/pick.ts

bun .selene/skills/sortes/bin/pick.ts --n 5        # bigger draw
bun .selene/skills/sortes/bin/pick.ts --print      # names only
bun .selene/skills/sortes/bin/pick.ts --json       # ok-first envelope, for a workflow to consume
bun .selene/skills/sortes/bin/pick.ts --seed 42    # deterministic, no mtime side-effect (tests/repro)
bun .selene/skills/sortes/bin/pick.ts --catalog DIR  # a different lens catalog
```
