...
> Ported from a companion house's operations library. Regenerated for **Selene Build**: native task-tool / orchestrator subagent dispatch, house `forge/` contracts, AGENTS.md orientation. No private harness lanes.
