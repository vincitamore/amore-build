...
> Ported from a companion house's operations library. Regenerated for **Selene Build**: native task-tool dispatch, model resolution via `[subagents.models]`, role/persona defaults, and spawn-time model override (user-guide §16).
