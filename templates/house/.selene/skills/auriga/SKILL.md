...
> Ported from a companion house's operations library. Regenerated for **Selene Build**: native task-tool dispatch, forge + AGENTS.md surfaces, cost accounting as window/turn/dispatch counts (no dollar rate tables).
