...
- Insight that only matters for one task stays in the task file or
  `forge/output/` until it earns a second use.
- Promote durable forge deliverables here; prune ephemeral pipeline notes.
- Every article carries at least one meaningful `[[wikilink]]`.
- Absence claims in knowledge carry the same evidence bar as presence claims
  (enumerate fully before "none").

Related: [[AGENTS]] · [[inbox/README]] · [[forge/README]]
