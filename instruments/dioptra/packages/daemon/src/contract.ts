// ─────────────────────────────────────────────────────────────────────────────
// @selene/daemon — the shared contract.
//
...
//   spec/regula-api.md     — what @selene/regula provides vs what we build
...
export interface CoreModule {
   ...
   * $DIOPTRA_WATCH_DEBOUNCE_MS quiet (default 300), bounded max-wait.
   */
