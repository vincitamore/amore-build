...
// Crash-context logger. OFF unless DIOPTRA_TUI_DEBUG is set. Writes synchronously (so the
// last line survives a native segfault) to ~/.dioptra/tui-debug.log. Used to identify what
...
// On by default while we chase native segfaults — set DIOPTRA_TUI_DEBUG=0 to silence.
const ENABLED = process.env.DIOPTRA_TUI_DEBUG !== '0';
